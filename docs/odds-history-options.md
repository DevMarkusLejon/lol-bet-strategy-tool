...
| Odds-API.io | Good first live-odds provider for building our own history from today onward; docs list esports support | Free key available; this setup observed a 100 requests/hour limit | Implemented in this app as `odds-api-io`. League of Legends LCK + Bet365 was validated with real API data. |
